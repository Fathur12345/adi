...
let handler = async (m, { conn }) => {
  // this.sendContact(m.chat, '6283822759168', 'Andrii Street Moonshine', m)
...
const buttonMessage = {contentText: 'Hallo Kak 👋\n\nSaya Adalah Pemilik Bot ini\nMau ingin Tau Tentang Apa Yah Kak?', footerText: 'Created By Andrii Street Moonshine ❤', buttons: buttons, headerType: 1}
// PEMBATAS YOO //
   await conn.sendContact(m.chat, '6283822759168', 'Andrii Street Moonshine', m)
   await time(1000)
